...
You should view and edit the source code of the application
...
## Change Cloud Shell Web Preview Port

Click the button below > Change Port > Enter value 9080 > Change and Preview

![alt text](images/local-dev-step2.png)

A new Tab will open with the Preview of the application
...
Navigate to the the OpenAPI UI by appending `openapi/ui` to the Cloud Shell URL after `BASE_URL/cloudshell.dev/`. for the following 3 REST APIs:
